...
class ParsianGateway(Gateway):
    ...
    _server_url_request = 'https://pec.shaparak.ir' \
                          '/NewIPGServices/Sale/SaleService.asmx?WSDL'
    _server_url_verify = 'https://pec.shaparak.ir' \
