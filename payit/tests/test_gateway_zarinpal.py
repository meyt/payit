...
class ZarinpalGatewayTest(unittest.TestCase):
    ...
    @mock.patch(
        "payit.gateways.zarinpal.Client", side_effect=get_side_effect()
    )
    def test_gateway(self, _):
        ...
        @mock.patch(
            "payit.gateways.zarinpal.Client",
        ...
        @mock.patch(
            "payit.gateways.zarinpal.Client",
            side_effect=get_side_effect(returned_status=300),
        )
        ...
        @mock.patch(
            "payit.gateways.zarinpal.Client",
            side_effect=get_side_effect(returned_status=101),
        )
