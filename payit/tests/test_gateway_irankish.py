...
class IrankishGatewayTest(unittest.TestCase):
    ...
    @mock.patch(
        "payit.gateways.irankish.Client", side_effect=get_side_effect()
    )
    def test_gateway(self, _):
        ...
        @mock.patch(
            "payit.gateways.irankish.Client",
            side_effect=get_side_effect(verify_result=1000),
        )
        ...
        @mock.patch(
            "payit.gateways.irankish.Client",
            side_effect=get_side_effect(verify_result=-90),
        )
