...
def get_side_effect(
    ...
    class ClientService:
        ...
        @staticmethod
        def RequestVerification(merchantConfigurationID, encryptedCredentials, payGateTranID):
            if raise_zeep_error:
                raise exceptions.Error('FAKE ZEEP ERROR')
        ...
        @staticmethod
        def RequestReconciliation(merchantConfigurationID, encryptedCredentials, payGateTranID):
